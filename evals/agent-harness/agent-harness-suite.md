...
Input: one normalized trace JSON ([`../_schema/trace-schema.md`](../_schema/trace-schema.md)), produced by
...
([`../severity-taxonomy.md`](../severity-taxonomy.md)). A single `bad` on any axis flags the trace.
