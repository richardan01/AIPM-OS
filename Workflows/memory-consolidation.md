...
| **AIPM-OS Knowledge/** | `Knowledge/People/`, `Knowledge/Reference/`, `Knowledge/Concepts/` | Canonical source of truth — AI PM mission, public-facing work, stable stakeholder profiles | Richard (deliberate) |
